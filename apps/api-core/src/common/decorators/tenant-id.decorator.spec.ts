...
describe('tenant scoping on institution controllers (#166)', () => {
  ...
  it('PlacementMatchController is guarded and scopes every route except multi-role feedback', () => {
    ...
    expect(unscoped.sort()).toEqual(['submitEmployerFeedback', 'submitStudentFeedback']);
  });
