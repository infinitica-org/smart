...
const LANGUAGE_SKILL_HINTS: Record<string, readonly string[]> = {
  javascript: ['LANGUAGE_PROFICIENCY', 'PROGRAMMING_FUNDAMENTALS_LOGIC'],
  typescript: ['LANGUAGE_PROFICIENCY', 'PROGRAMMING_FUNDAMENTALS_LOGIC'],
  python: ['LANGUAGE_PROFICIENCY', 'PYTHON_R_DATA_ANALYSIS'],
  java: ['LANGUAGE_PROFICIENCY', 'OBJECT_ORIENTED_PROGRAMMING'],
  'c++': ['LANGUAGE_PROFICIENCY', 'DATA_STRUCTURES_ALGORITHMS'],
  c: ['PROGRAMMING_FUNDAMENTALS_LOGIC'],
  go: ['LANGUAGE_PROFICIENCY'],
  rust: ['LANGUAGE_PROFICIENCY'],
  ruby: ['LANGUAGE_PROFICIENCY'],
  php: ['LANGUAGE_PROFICIENCY'],
  kotlin: ['LANGUAGE_PROFICIENCY', 'OBJECT_ORIENTED_PROGRAMMING'],
  swift: ['LANGUAGE_PROFICIENCY'],
  sql: ['DATABASE_FUNDAMENTALS'],
  plpgsql: ['DATABASE_FUNDAMENTALS'],
  html: ['FRONTEND_BACKEND_FRAMEWORK'],
  css: ['FRONTEND_BACKEND_FRAMEWORK'],
  scss: ['FRONTEND_BACKEND_FRAMEWORK'],
  vue: ['FRONTEND_BACKEND_FRAMEWORK'],
  dockerfile: ['DEPLOYMENT_CICD_BASICS'],
  shell: ['DEPLOYMENT_CICD_BASICS'],
  'jupyter notebook': ['PYTHON_R_DATA_ANALYSIS', 'MACHINE_LEARNING_FUNDAMENTALS'],
};
