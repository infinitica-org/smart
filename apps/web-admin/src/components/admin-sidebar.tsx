  ...
  return (
    <aside className="w-64 border-r border-[var(--surface-border)] bg-[var(--surface)] flex flex-col min-h-dvh flex-shrink-0">
      <div className="p-6 border-b border-[var(--surface-border)]">
        <span className="text-xs font-semibold uppercase tracking-[0.2em] text-brand-600">SMART Console</span>
        <h2 className="text-lg font-bold tracking-tight text-[var(--text-primary)]">System Admin</h2>
      </div>
