    ...
    <div className="flex min-h-screen flex-col justify-between bg-white px-4 py-8 font-sans selection:bg-emerald-500/20 antialiased">
      ...
      <main className="mx-auto w-full max-w-[440px] px-2 py-6">
        <div className="mb-8 flex justify-center">
          <Link href="/company/login" aria-label="SMART home">
            <Image
              src={textLogo}
              alt="SMART"
              width={120}
        ...
        {/* <div className="mx-auto mb-6 flex w-full max-w-[280px] rounded-[11px] bg-neutral-100 p-1 text-center">
          <Link
            href="/login"
        ...
        <h1 className="text-center font-heading text-2xl font-bold tracking-tight text-neutral-900 sm:text-[28px] leading-snug">
        ...
        <div className="mt-8 space-y-4">
          ...
          <button
            ...
            disabled={loading}
            className="flex h-11 w-full items-center justify-center gap-3 rounded-[11px] border border-neutral-200 bg-white px-4 text-sm font-semibold text-neutral-900 shadow-sm transition-all hover:bg-neutral-50 active:scale-[0.99] disabled:opacity-60"
          >
          ...
          <div className="relative flex items-center justify-center py-2">
            ...
            <span className="absolute bg-white px-3 text-xs font-medium text-neutral-400">or</span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <input
                ...
                className="h-11 w-full rounded-[11px] border border-neutral-200 bg-white px-3.5 text-sm font-medium text-neutral-900 shadow-sm outline-none transition-all placeholder:text-neutral-400 focus:border-black focus:ring-2 focus:ring-black/10"
              />
            </div>
          ...
          {/* Registration Link */}
          <div className="border-t border-neutral-200 pt-4 text-center text-xs sm:text-sm text-neutral-500 space-y-2">
            <div>
              New to SMART?{' '}
              <Link
            ...
            <div className="text-xs text-neutral-400">
              ...
              <Link
                href="/login"
                className="font-medium text-neutral-700 underline underline-offset-4 hover:text-black"
              >
                Student Sign In
              </Link>
            </div>
      ...
      <footer className="mx-auto mt-8 max-w-xl text-center text-[11px] leading-relaxed text-neutral-400 px-4">
