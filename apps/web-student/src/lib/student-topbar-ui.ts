/** Navbar-only visual tokens — aligned with TPO topbar (monochrome active states). */
...
export const topbarNavUnderlineClass =
  'pointer-events-none absolute inset-x-2.5 bottom-0 h-[2px] bg-[var(--student-accent)] lg:inset-x-3';
