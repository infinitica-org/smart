...
export function SkillVerifyRow({
  ...
  return (
    <li className="grid grid-cols-1 items-center gap-3 rounded-xl border border-gray-200 bg-gray-50/50 px-3 py-3 lg:grid-cols-[minmax(12rem,1.5fr)_8.5rem_10rem_8.5rem]">
