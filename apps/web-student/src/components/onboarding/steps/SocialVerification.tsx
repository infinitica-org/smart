      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full border border-gray-200 rounded-xl pl-16 pr-4 py-3 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-900/10 focus:border-gray-400 transition-all"
          />
        </div>
        ...
        {linkedin?.verified ? (
          <motion.div
            ...
            className="mt-1 flex items-center gap-3 rounded-xl border border-emerald-200 bg-emerald-50 p-3"
          >
            {linkedin.pictureUrl ? (
              <img
          ...
          <motion.button
            ...
            onClick={() => void handleVerifyLinkedin()}
            className="mt-1 inline-flex items-center justify-center gap-2 h-10 px-4 rounded-xl border border-[#0a66c2]/30 bg-[#0a66c2]/[0.06] text-sm font-medium text-[#0a66c2] hover:bg-[#0a66c2]/10 disabled:opacity-40 disabled:cursor-not-allowed transition-colors w-fit"
          >
            {linkedinLoading ? (
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full border border-gray-200 rounded-xl pl-16 pr-4 py-3 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-900/10 focus:border-gray-400 transition-all disabled:opacity-60"
          />
        </div>
        ...
        {!github?.verified && (
          <button
            ...
            className="mt-1 inline-flex items-center justify-center gap-2 h-10 px-4 rounded-xl border border-gray-200 bg-gray-50 text-sm font-medium text-gray-700 hover:bg-gray-100 disabled:opacity-40 disabled:cursor-not-allowed transition-colors w-fit"
          >
            {githubLoading ? (
              <Loader2 className="w-4 h-4 animate-spin" />
            ) : (
        ...
        <AnimatePresence>
          {githubPreview ? (
            <motion.div
              ...
              exit={{ opacity: 0, y: -6 }}
              transition={{ duration: 0.25 }}
              className="mt-1 flex items-start gap-3 rounded-xl border border-gray-200 bg-gray-50 p-3"
            >
              <img
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-gray-900">
                  ...
                  <span className="text-gray-400 font-normal">@{githubPreview.login}</span>
                </p>
                {githubPreview.bio ? (
                  <p className="text-xs text-gray-500 mt-0.5 line-clamp-2">{githubPreview.bio}</p>
                ) : null}
                ...
                <div className="flex gap-2 mt-2">
                  <button
                    ...
                    className="h-8 px-3 rounded-lg bg-gray-900 text-white text-xs font-semibold"
                  >
                    Yes, that&apos;s me
                  </button>
                  <button
                    ...
                    className="h-8 px-3 rounded-lg border border-gray-200 text-gray-600 text-xs"
                  >
                    Not me
                  </button>
                </div>
