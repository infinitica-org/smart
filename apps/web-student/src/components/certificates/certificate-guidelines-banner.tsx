      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex flex-col gap-2">
          <div className="flex items-center justify-between">
            <h4 className="font-semibold text-white">Certification Upload Guidelines</h4>
            <span className="inline-flex items-center gap-1 rounded-full bg-white/5 px-2.5 py-0.5 text-[11px] font-medium text-white/60">
          ...
          <div className="mt-1 grid grid-cols-1 gap-2.5 sm:grid-cols-2">
            <div className="flex items-start gap-2 rounded-xl border border-success/20 bg-success/5 p-2.5">
              ...
              <div>
                <p className="text-xs font-medium text-white">Accepted Documents</p>
            ...
            <div className="flex items-start gap-2 rounded-xl border border-danger/20 bg-danger/5 p-2.5">
              ...
              <div>
                <p className="text-xs font-medium text-white">Not Accepted (Will Be Rejected)</p>
                <p className="text-[11px] text-white/50">
