...
- **L1 (Aptitude/Fundamentals)** tests the *knowledge* layer of a domain — can they recall and reason about the concept correctly.
- **L2 (Applied/Programming)** tests the *doing* layer — can they use the concept to build or solve something real.
- **L3 (Communication/Domain)** and **L4 (Verification)** draw specifically from each role's Domain E — the *explain-and-defend* layer.
...
| *(All domains, integrated)* | — | Build a scoped full-stack feature end-to-end | **L5** | Real brief + deliverable + presentation |
...
| *(All domains, integrated)* | — | Build and evaluate a small end-to-end ML/GenAI feature | **L5** | Real brief + deliverable + presentation |
...
| *(All domains, integrated)* | — | Analyze a real dataset end-to-end, produce a recommendation | **L5** | Real brief + deliverable + presentation |
...
| *(All domains, integrated)* | — | Deploy a real application with a working CI/CD pipeline | **L5** | Real brief + deliverable + presentation |
...
| *(All domains, integrated)* | — | Triage and respond to a simulated incident end-to-end | **L5** | Real brief + deliverable + presentation |
