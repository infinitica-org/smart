...
export const ENDPOINT_RATE_LIMITS: readonly RateLimitPolicy[] = [
  ...
  },
  {
    ...
    windowSeconds: 60,
    burst: 5,
    redisKey: 'rl:corroboration:read:user:{id}',
    rationale: 'S6-RM-10 passive-signal readout; supporting evidence only.',
  },
  {
    key: 'corroboration.adminFlags',
    scope: 'USER',
    limit: 60,
    windowSeconds: 60,
    burst: 10,
    redisKey: 'rl:corroboration:admin:user:{id}',
    rationale: 'S6-RM-10 admin review-flag list and resolve.',
  },
  {
    key: 'corroboration.refresh',
    scope: 'USER',
    limit: 4,
    windowSeconds: 3_600,
    burst: 1,
    redisKey: 'rl:corroboration:refresh:user:{id}',
  ...
  },
  {
    ...
    windowSeconds: 60,
    burst: 3,
    redisKey: 'rl:company:onboarding:start:ip:{id}',
    rationale: 'Caps public company onboarding session creation and duplicate signup abuse.',
    onViolation: 'IP_CHALLENGE',
  },
  {
    key: 'company.onboarding.read',
    scope: 'IP',
    limit: 60,
    windowSeconds: 60,
    burst: 15,
    redisKey: 'rl:company:onboarding:read:ip:{id}',
    rationale: 'Session polling while the applicant completes the wizard.',
  },
  {
    key: 'company.onboarding.draft',
    scope: 'IP',
    limit: 30,
    windowSeconds: 60,
    burst: 10,
    redisKey: 'rl:company:onboarding:draft:ip:{id}',
    rationale: 'Autosave drafts during onboarding; keyed by session token server-side.',
  },
  {
    key: 'company.onboarding.emailSend',
    scope: 'IP',
    limit: 5,
    windowSeconds: 60,
    burst: 2,
    redisKey: 'rl:company:onboarding:email_send:ip:{id}',
    rationale: 'Corporate email verification resend cooldown at the IP edge.',
  },
  {
    key: 'company.onboarding.emailVerify',
    scope: 'IP',
    limit: 15,
    windowSeconds: 60,
    burst: 5,
    redisKey: 'rl:company:onboarding:email_verify:ip:{id}',
    rationale: 'OTP brute-force defence on corporate email verification.',
  },
  {
    key: 'company.onboarding.documentUpload',
    scope: 'IP',
    limit: 20,
    windowSeconds: 60,
    burst: 5,
    redisKey: 'rl:company:onboarding:doc_upload:ip:{id}',
    rationale: 'KYC document uploads; aligns with 5MB multipart cap per file.',
  },
  {
    key: 'company.onboarding.documentDelete',
    scope: 'IP',
    limit: 30,
    windowSeconds: 60,
    burst: 10,
    redisKey: 'rl:company:onboarding:doc_delete:ip:{id}',
    rationale: 'Remove mistaken uploads before submit.',
  },
  {
    key: 'company.onboarding.submit',
    scope: 'IP',
    limit: 5,
    windowSeconds: 60,
    burst: 2,
